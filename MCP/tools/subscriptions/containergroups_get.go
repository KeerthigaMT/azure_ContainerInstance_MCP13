...
func Containergroups_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateContainergroups_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft.ContainerInstance_containerGroups_containerGroupName",
		mcp.WithDescription("Get the properties of the specified container group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Containergroups_getHandler(cfg),
	}
}
