...
func Containergroups_listbyresourcegroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ContainerInstance/containerGroups%s", cfg.BaseURL, subscriptionId, resourceGroupName, queryString)
...
func CreateContainergroups_listbyresourcegroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft.ContainerInstance_containerGroups",
		mcp.WithDescription("Get a list of container groups in the specified subscription and resource group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Containergroups_listbyresourcegroupHandler(cfg),
	}
}
