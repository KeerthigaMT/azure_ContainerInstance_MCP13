...
func Containergroups_startHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ContainerInstance/containerGroups/%s/start%s", cfg.BaseURL, subscriptionId, resourceGroupName, containerGroupName, queryString)
...
func CreateContainergroups_startTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft.ContainerInstance_containerGroups_containerGroupName_start",
		mcp.WithDescription("Starts all containers in a container group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Containergroups_startHandler(cfg),
	}
}
