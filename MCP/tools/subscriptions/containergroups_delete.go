...
func Containergroups_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateContainergroups_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft.ContainerInstance_containerGroups_containerGroupName",
		mcp.WithDescription("Delete the specified container group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Containergroups_deleteHandler(cfg),
	}
}
