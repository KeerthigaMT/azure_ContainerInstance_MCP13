...
func ListcachedimagesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/providers/Microsoft.ContainerInstance/locations/%s/cachedImages%s", cfg.BaseURL, subscriptionId, location, queryString)
...
func CreateListcachedimagesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_providers_Microsoft.ContainerInstance_locations_location_cachedImages",
		mcp.WithDescription("Get the list of cached images."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListcachedimagesHandler(cfg),
	}
}
