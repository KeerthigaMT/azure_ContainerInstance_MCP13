...
func Containergroups_createorupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ContainerInstance/containerGroups/%s%s", cfg.BaseURL, subscriptionId, resourceGroupName, containerGroupName, queryString)
...
func CreateContainergroups_createorupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft.ContainerInstance_containerGroups_containerGroupName",
		mcp.WithDescription("Create or update container groups."),
		...
		mcp.WithString("containerGroup", mcp.Required(), mcp.Description("The properties of the container group to be created or updated.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Containergroups_createorupdateHandler(cfg),
	}
}
