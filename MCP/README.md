# ContainerInstanceManagementClient MCP Server

This MCP (Model Content Protocol) server provides access to ContainerInstanceManagementClient API functionality through HTTP, HTTPS, and STDIO transport modes.
